...
export const frequencyCatalog = {
  alpha: {
    ...
    listeningType: 'Binaural frequency · Headphones required for the binaural effect',
    signalType: 'binaural',
    leftHz: 180,
    rightHz: 190,
  ...
  gamma: {
    ...
    hz: '40 Hz',
    state: 'Gamma Clarity',
    ariaLabel: 'Open Gamma 40 Hz — Gamma Clarity details',
    ...
    leftHz: 220,
    rightHz: 260,
    actionLabel: 'Build a Gamma Clarity voyage'
  },
  theta: {
    id: 'theta',
    frequency: 'Theta',
    ...
    ariaLabel: 'Open Theta 4 Hz — Reflective Space details',
    ...
    leftHz: 95,
    rightHz: 99,
    actionLabel: 'Build a Reflective Space voyage'
  },
  delta: {
    id: 'delta',
    frequency: 'Delta',
  ...
  abundance: {
    ...
    technical: 'Pure 888 Hz tone · Clean uninterrupted tone',
